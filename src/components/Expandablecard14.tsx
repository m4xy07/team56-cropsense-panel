...
export function MorphingDialogBasicFourteen() {
  ...
  return (
    <div
      ...
      className='flex max-w-[270px] md:w-[150px] md:h-[180px] items-center justify-center flex-col overflow-hidden border border-zinc-950/10 bg-black dark:border-zinc-50/10 dark:bg-zinc-900'
    >
      <div className='flex grow flex-row items-center justify-between px-3 py-2'>
        <div>
          <div className='text-zinc-950 text-center dark:text-white'>
            {harvestableMonths.length > 0 ? harvestableMonths[0].month : "Loading..."}
          </div>
          ...
          <div className='text-zinc-700 text-center dark:text-zinc-200'>
            {harvestableMonths.length > 0 ? harvestableMonths[0].wholesale_price : "Loading..."}
          </div>
          <div className='text-zinc-950 pt-2 text-center dark:text-zinc-50/70 text-[14px]'>
            Retail Price
          </div>
          <div className='text-zinc-700 text-center dark:text-zinc-200'>
            {harvestableMonths.length > 0 ? harvestableMonths[0].retail_price : "Loading..."}
          </div>
        </div>
      </div>
    </div>
